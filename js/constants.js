...
export const OBSTACLE_SPAWN_INTERVAL = 2.0; // Increased from 1.67 for mobile
export const COLLECTABLE_SPAWN_INTERVAL = 1.5; // Increased from 1.17 for mobile
...
export const OBSTACLE_SPIKE_SEGMENTS = 6; // Reduced from 8 for mobile
...
export const TRAIL_PARTICLE_MAX_COUNT = 50; // Reduced from 200 for mobile
export const TRAIL_PARTICLE_LIFESPAN = 1.0; // Reduced from 1.67 for mobile
export const TRAIL_PARTICLE_SIZE = 0.2;
export const TRAIL_PARTICLE_INITIAL_OPACITY = 0.6;
export const TRAIL_SPAWN_INTERVAL = 0.05; // Reduced frequency from 0.017 for mobile
...
export const MAX_ACTIVE_BUILDINGS = 30; // Reduced from 100 for mobile
...
export const STREETLIGHT_SPAWN_INTERVAL = 3.0; // Increased from 1.5 for mobile
export const MAX_ACTIVE_STREETLIGHTS = 8; // Reduced from 15 for mobile
...
export const DRILL_SPAWN_CHANCE_PER_SECOND = 0.03; // Reduced from 0.05 for mobile
export const DRILL_SPAWN_CHECK_INTERVAL = 1.5; // Increased from 1.0 for mobile
...
export const PEDESTRIAN_SPAWN_INTERVAL = 4.0; // Increased from 2.0 for mobile
export const PEDESTRIAN_SPAWN_CHANCE = 0.3; // Reduced from 0.4 for mobile
...
export const MAX_ACTIVE_PEDESTRIANS = 10; // Reduced from 25 for mobile
...
export const MUSIC_FFT_SIZE = 32; // Reduced from 64 for mobile
...
export const WIND_PARTICLE_COUNT = 8; // Reduced from 15 for mobile
export const WIND_PARTICLE_SPEED_MIN = 0.3;
export const WIND_PARTICLE_SPEED_MAX = 0.6;
export const WIND_PARTICLE_LIFE = 1.0; // Reduced from 1.33 for mobile
export const WIND_PARTICLE_SIZE = 0.15;
export const WIND_PARTICLE_SPAWN_RATE = 0.1; // Reduced frequency from 0.05 for mobile
export const WIND_PARTICLE_SPREAD = 8; // How wide the wind effect spreads around car

// Perfection burst effect constants
export const PERFECTION_BURST_PARTICLE_COUNT = 12; // Reduced from 25 for mobile
export const PERFECTION_BURST_SPEED_MIN = 0.2;
export const PERFECTION_BURST_SPEED_MAX = 0.5;
export const PERFECTION_BURST_LIFE = 0.8; // Reduced from 1.0 for mobile
export const PERFECTION_BURST_SIZE = 0.25;
export const PERFECTION_BURST_SPREAD = 6; // How wide the burst spreads
export const PERFECTION_BURST_TRIGGER_INTERVAL = 2.0; // Increased from 1.5 for mobile

// Enhanced trail constants for perfection
export const PERFECTION_TRAIL_SIZE_MULTIPLIER = 2.0; // Reduced from 2.5 for mobile
export const PERFECTION_TRAIL_OPACITY_MULTIPLIER = 1.3; // Reduced from 1.5 for mobile
export const PERFECTION_TRAIL_SPAWN_RATE_MULTIPLIER = 0.7; // Less frequent than before for mobile

// Spawn conflict detection constants
export const MIN_SPAWN_DISTANCE = 8; // Minimum distance between obstacles and collectables
export const SPAWN_RETRY_ATTEMPTS = 3; // Reduced from 5 for mobile
...
export const HEADLIGHT_INTENSITY = 30; // Reduced from 50 for mobile
export const HEADLIGHT_DISTANCE = 50; // Reduced from 75 for mobile
export const HEADLIGHT_ANGLE = Math.PI / 6; // Reduced beam angle for mobile
export const HEADLIGHT_PENUMBRA = 0.5; // Reduced from 0.75 for mobile
export const HEADLIGHT_DECAY = 1.5; // Reduced from 1.8 for mobile
...
export const HEADLIGHT_TARGET_Z_OFFSET = -15 * CAR_SCALE; // Reduced from -20 for mobile

// --- Mobile Performance Constants ---
export const MOBILE_PERFORMANCE_MODE = true; // Enable mobile optimizations
export const REDUCED_GEOMETRY_SEGMENTS = 6; // Use fewer segments for geometry on mobile
export const MOBILE_TEXTURE_SIZE = 128; // Smaller texture size for mobile (reduced from 256)
